...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private View addRemoveView(LayoutInflater inflater) {
        ...
        removeFloatingWidgetView = inflater.inflate(R.layout.service_floating_widget_remove, null);
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        mFloatingWidgetView = inflater.inflate(R.layout.service_floating_widget, null);
...
class NotesAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView txtNote = listItemView.findViewById(R.id.txt_note);
        txtNote.setText(getItem(position));
